/** layui v2.6.2 | Released under the MIT license */ ;
! function(t) {
	"use strict";
	var e = document,
		n = {
	...
	r.prototype.cache = n, r.prototype.define = function(t, e) {
		...
		function s() {
			l.push(layui[d]), t.length > 1 ? p.use(t.slice(1), r, l) : "function" == typeof r && r.apply(layui, l)
		}
		var p = this,
...
! function(e) {
	...
	g.isLeapYear = function(e) {
		...
		e.remove(g.thisElemDate), n ? t.elem.append(l) : (document.body.appendChild(l), e.position()), e.checkDate().calendar(
			null, 0, "init"), e.changeEvent(), g.thisElemDate = e.elemID, "function" == typeof t.ready && t.ready(lay.extend({},
			t.dateTime, {
		...
		t.elem && (a.innerHTML = e || "", lay(t.elem).find("." + c).remove(), t.elem.appendChild(a), clearTimeout(t.hinTimer),
			t.hinTimer = setTimeout(function() {
				lay(t.elem).find("." + c).remove()
			}, 3e3))
	...
	}, g.prototype.limit = function(e, t, a, n) {
		var l, i = this,
			r = i.config,
			o = {},
		...
		return m.year < y[0] && (m.year = y[0], s.hint(u.invalidDate)), m.year > y[1] && (m.year = y[1], s.hint(u.invalidDate)),
			...
			"cn" === d.lang ? (lay(g[0]).attr("lay-type", "year").html(m.year + "年"), lay(g[1]).attr("lay-type", "month").html(
				...
				"year").html(m.year)), f && (d.range ? e && (s.listYM = [
				...
				.find(h), null, 0, ["hours", "minutes", "seconds"]), s.setBtnStatus(), s
		...
		if (D[0] < 1 && (D[0] = 1), "year" === e) {
			...
			var k = function() {
				...
				}), n.range || a.limit(lay(a.footer).find(h), a[x], 0, ["hours", "minutes", "seconds"])
			};
			n.range ? a[x] || (a[x] = {
				hours: 0,
				minutes: 0,
		...
		if (g && u.removeChild(g), u.appendChild(y), "year" === e || "month" === e) lay(a.elemMain[t]).addClass(
			"laydate-ym-show"), lay(y).find("li").on("click", function() {
			var i = 0 | lay(this).attr("lay-ym");
			if (!lay(this).hasClass(s)) {
				0 === t ? (l[e] = i, a.limit(lay(a.footer).find(h), null, 0)) : a.endDate[e] = i;
				...
				d ? (lay(y).find("." + o).removeClass(o), lay(this).addClass(o), "month" === n.type && "year" === e && (a.listYM[
					...
					"year" === e) && a.setValue(a.parse()).remove().done(), a.done(null, "change")), lay(a.footer).find(p).removeClass(
					s)
			}
		});
		else {
		...
		}), lay(e.elem).find("." + f).remove()
	}, g.prototype.setBtnStatus = function(e, t, a) {
		var n, l = this,
			i = l.config,
			r = l.lang(),
			o = lay(l.footer).find(h);
		...
		var t = this,
			...
			o = function(o) {
				...
				return s && (r[0] = o ? r[0] - 15 : r[0] + 15, t.list("year", e)), y && (o ? r[0]-- : r[0]++, t.list("month", e)),
					(s || y) && (lay.extend(n, {
						year: r[0]
					}), l && (n.year = r[0]), a.range || t.done(null, "change"), a.range || t.limit(lay(t.footer).find(h), {
						year: r[0]
					})), t.setBtnStatus(), s || y
			};
		return {
		...
		lay(e.elem).on("click", function(e) {
			...
			lay(a[0]).on("click", function(a) {
				...
				var n = lay(this),
					l = n.attr("lay-ym"),
					i = n.attr("lay-type");
				l && (l = l.split("-"), e.listYM[t] = [0 | l[0], 0 | l[1]], e.list(i, t), lay(e.footer).find(p).addClass(s))
		...
		a.elem[0] && !a.elem[0].eventHandler && (n(a.elem, "bind"), n(a.eventElem), lay(document).on("click", function(e) {
			...
			13 === e.keyCode && lay("#" + t.elemID)[0] && t.elemID === g.thisElemDate && (e.preventDefault(), lay(t.footer).find(
				h)[0].click())
...
layui.define(["laytpl", "laypage", "layer", "form", "util"], function(e) {
	...
	I.prototype.config = {
		...
		}, I.prototype.renderTotal = function(e, t) {
			var i = this,
				a = i.config,
				l = {};
			if (a.totalRow) {
